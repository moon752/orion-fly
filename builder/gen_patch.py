...
Used when the AI back‑end is unavailable.
"""
from pathlib import Path
import datetime, textwrap, json, sys

STUB = textwrap.dedent("""        # Auto‑generated by ORION on {ts}
...
if __name__ == "__main__":
    print(json.dumps({"generated": make_patch(sys.argv[1] if len(sys.argv)>1 else "demo.py")}))
